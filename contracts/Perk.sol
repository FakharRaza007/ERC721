...
contract Ownable {
    ...
    constructor() {
        ownerAddress = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    }
...
contract PERKTOKEN is IERC20, Ownable {
    ...
    uint256 private constant MAX = 100000000 * 10 ** 18;
    uint256 private _tTotal = 12 * 10 ** 5 * 10 ** 18;
    ...
    uint256 public _maxTxAmount = 200 ether;
    uint256 public numTokensSellToAddToLiquidity = 50 ether;
    //30000000000000050.....
...
//===========================================
    ...
    function _getCurrentSupply() public view returns (uint256, uint256) { //almost=======================
