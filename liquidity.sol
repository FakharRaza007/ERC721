...
contract ZeroXAISwapToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "0xROGSwap";
    string private constant _symbol = "0xRGSwap";
    uint256 private constant _totalSupply = 1_000_000 * 10**18; // 1 million
    uint256 public minSwap = 200 * 10**18; //Set to 0.3% (Should be between 0.01% to 0.5% of the total supply)
    uint8 private constant _decimals = 18;

    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) private isWalletLimitExempt;
    mapping (address => bool) private isTxLimitExempt;
    uint256 public _walletMax =     20 * 10**18; // 2%
    ...
    constructor() {
        ...
        marketingWallet = payable(0x8fCa45661b89845AcdE65750B9D427fCA2FFE688); //0xc0689A2E00B524e4b210Bf8E9F1e9e76A46f0461 Marketing Fee Receiver Addresss
    ...
    function IncludeWalletinFees(address wallet) external onlyOwner {
     ...
     function setSwapAndLiquify(uint8 _inSwapAndLiquify) external onlyOwner {
    ...
    function _transfer(
        ...
        require(isTradingEnabled || from == ownerAddress || to == ownerAddress, "Not Open");
        // from passing the blocked statement  the all section must have to false.......
...
//=======================================================
        ...
        require(balanceOf(to).add(amount) <= _walletMax, "exceeds");
...
//contractAdress =  0x865FdF791a4632a7E25d1f84D24491D0e7e8251b
//pair adress  =    0xce602eBE3AE632ed618E988bca821280C750aF1B
//owner         =   0xc0689A2E00B524e4b210Bf8E9F1e9e76A46f0461
// marketing     =  0x8fCa45661b89845AcdE65750B9D427fCA2FFE688
